      ...
      <div className="rounded-3xl border border-zinc-200/90 bg-white p-6 shadow-xl dark:border-zinc-800/80 dark:bg-zinc-900/90 sm:p-10">
        ...
        {activeStep === 0 && (
          <div className="space-y-6">
            ...
            {/* Multiple Photos Gallery Showcase */}
            <div className="rounded-2xl border border-zinc-200 bg-slate-50/70 p-4 sm:p-5 dark:border-zinc-800 dark:bg-zinc-950/60">
              <PhotoManager
                photos={formData.photos || []}
                avatarUrl={formData.avatarUrl}
                coverUrl={formData.coverUrl}
                onChange={(newPhotos) => setFormData({ ...formData, photos: newPhotos })}
                onSetAvatar={(url) => setFormData({ ...formData, avatarUrl: url })}
                onSetCover={(url) => setFormData({ ...formData, coverUrl: url })}
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="divide-y divide-zinc-800 rounded-2xl border border-zinc-800 bg-zinc-950/60">
              ...
              <PrivacyRow
                ...
                value={formData.privacy?.photos || "PUBLIC"}
                onChange={(val) =>
                  setFormData({
                    ...formData,
                    privacy: { ...formData.privacy, photos: val },
                  })
                }
              />
            </div>
